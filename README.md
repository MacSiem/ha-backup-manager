...
Manage Home Assistant backups with scheduling, restore and cloud sync
...
### Manual
1. Download `ha-backup-manager.js` from this repository
2. Copy to `/config/www/community/ha-backup-manager/`
